...
const Menu = () => (
  <div style={menuStyle}>    
    <NavLink activeStyle={navLinkStyle} exact to="/">anecdotes</NavLink> &nbsp;
    <NavLink activeStyle={navLinkStyle} exact to="/create">create new</NavLink> &nbsp;
    <NavLink activeStyle={navLinkStyle} exact to="/about">about</NavLink> &nbsp;
  </div>
)
